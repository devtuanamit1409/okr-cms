...
export interface ApiPostionPostion extends Schema.CollectionType {
  collectionName: 'postions';
  info: {
    singularName: 'postion';
    pluralName: 'postions';
    displayName: 'Postion';
  };
  options: {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::postion.postion': ApiPostionPostion;
